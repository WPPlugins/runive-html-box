...
Description: The plugin is saved as a widget on your Wordpress blog. Thanks to this feature, you can add it to your blog via drag and drop in any theme.
Author: Runive
Version: 1.0
...
?>
    Title <input type="text" name="RnvHTMLBoxTitle" id="RnvHTMLBoxTitle" size="23" value="<?php echo $RnvHTMLBoxTitle;?>"><br/>
    Code<br/><textarea name="RnvHTMLBoxContent" id="RnvHTMLBoxContent" rows="15" style="width: 90%;"><?php echo $RnvHTMLBoxContent;?></textarea><br/>
<?php 
}
...
?>
    Title <input type="text" name="RnvHTMLBoxTitle2" id="RnvHTMLBoxTitle2" size="23" value="<?php echo $RnvHTMLBoxTitle2;?>"><br/>
    Code<br/><textarea name="RnvHTMLBoxContent2" id="RnvHTMLBoxContent2" rows="15" style="width: 90%;"><?php echo $RnvHTMLBoxContent2;?></textarea><br/>
<?php 
}
